...
class TempSeeder extends DatabaseSeeder
{
    ...
    public function run()
    {
        ...
        DB::table('Phong')->insert([
            ...
            ["id"=>$this->phongchuathue2,"tenphong"=>"Phòng chưa thuê 2","songuoimax"=>4,"giaphong"=>3000000,"trangthai"=>true],
            ["id"=>$this->phongdong,"tenphong"=>"Phòng đóng","songuoimax"=>2,"giaphong"=>2000000,"trangthai"=>false],
            ["id"=>$this->phongdathue,"tenphong"=>"Phòng đã thuê","songuoimax"=>2,"giaphong"=>2000000,"trangthai"=>true]
        ]);
